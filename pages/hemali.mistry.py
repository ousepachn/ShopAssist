...
st.info("""The demo is limited to the last 50 posts (no stories, highlights).\nHere are a few sample queries 
        [What is your skincare routine?,   How do you pick a color palette for your skin?,  recommendations for traditional indian dresses?]""")  
...
if "messages5" not in st.session_state.keys():
    st.session_state["messages5"] = [{"role": "assistant", "content": "Ask about the products I featured to get link details and discount codes"}]
avatar = {
    "assistant": "🍾",
    "user": "🐱"
}
...
if prompt := st.chat_input(placeholder=placeholder):
    st.session_state.messages5.append({"role": "user", "content": prompt})
    ...
    st.session_state.messages5.append({"role": "assistant", "content": response})
